...
<div class="big-input">
    <input name="sub_tags_en" type="text" id="sub_tags_en" placeholder="sub tags(en), separated by underline">
</div>
...
<div class="big-input fa">
    <input name="sub_tags_fa" type="text" id="sub_tags_fa" placeholder="sub tags(fa), separated by underline">
</div>
...
<div class="big-input">
    <input name="sub_tags_gr" type="text" id="sub_tags_gr" placeholder="sub tags(gr), separated by underline">
</div>
...
<div class="big-input fa">
    <input name="sub_tags_ar" type="text" id="sub_tags_ar" placeholder="sub tags(ar), separated by underline">
</div>
