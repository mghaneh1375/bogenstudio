...
@if (\Illuminate\Support\Facades\App::getLocale() == 'fa' || \Illuminate\Support\Facades\App::getLocale() == 'ar')
    <link rel="stylesheet"
        href="{{ \Illuminate\Support\Facades\URL::asset('/assets/css/solution/solutions-rtl.css?v=2.1') }}">
@endif

<link rel="stylesheet"
    href="{{ \Illuminate\Support\Facades\URL::asset('/assets/css/solution/solution-mobile.css?v=2.1') }}">
...
<div id="solutions">
    ...
    <div id="all">
        <div id="categories-container" class="hidden close">
